...
{
    private readonly Mock<IEventContext> _eventContext = new();
    ...
    public void ShouldUpdateMessage()
    {
        ...
        var testEvent = new TestEvent("test name", "original test display name", testCase);
        ...
        patchedMessage.GetValue("resultDisplayName").ShouldBe("original test display name");
